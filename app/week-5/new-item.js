    ...
    return (
        <form onSubmit={handleSubmit} className="w-100 mx-auto">
            <div>
                <input 
                    type="text"
                    className="p-2 m-2 rounded border w-100 border-amber-500 bg-white focus:bg-orange-100"
            ...
            <div className="inline-flex">
                ...
                <div>
                    <select type="date" className="p-2 m-2 w-40 ml-18 rounded border border-amber-500 bg-white focus:bg-orange-100" onChange={handleCategory} value={category}> 
